...
function CategoryPageContent({ categoryName, categoryFilter, description }: CategoryPageProps) {
...
export default function SmallDogsPage() {
  return (
    <CategoryPageContent
      categoryName="Small Dogs"
      categoryFilter="small"
      description="Perfect for apartments and small spaces. Discover small dog breeds that are great companions."
    />
  )
}
