...
export default function WorkingDogsPage() {
  return (
    <CategoryPageContent
      categoryName="Working Dogs"
      categoryFilter="working"
      description="High energy and intelligent. Discover working dog breeds perfect for active individuals and families."
    />
  )
}
